import englishLexicon from "../data/English/lexicon_from_posjs.json" assert { type: "json" };
import dutchLexicon from "../data/Dutch/brill_Lexicon.json" assert { type: "json" };
/*
  Lexicon class
