import { knownAbbreviations } from "../util/abbreviations_en.js";
/*
...
function peg$parse(input, options) {
    ...
    var peg$FAILED = {}, peg$startRuleFunctions = { s: peg$parses }, peg$startRuleFunction = peg$parses, peg$c0 = function (sentences) {
        let result = [];
        ...
        result.push(close);
        return result;
    }, peg$c6 = /^[ \t\n\r.?!]/, peg$c7 = peg$classExpectation([" ", "\t", "\n", "\r", ".", "?", "!"], false, false), peg$c8 = function () {
        return text();
    }, peg$c9 = /^[ \t\n\r]/, peg$c10 = peg$classExpectation([" ", "\t", "\n", "\r"], false, false), peg$c11 = function (t) {
        return t;
    }, peg$c12 = /^[^ \t\n\r!?([}"`)\]}"`0-9@]/, peg$c13 = peg$classExpectation([" ", "\t", "\n", "\r", "!", "?", "(", "[", "}", "\"", "`", ")", "]", "}", "\"", "`", ["0", "9"], "@"], true, false), peg$c14 = function (word) {
        const tmp = word.reduce((accu, elt) => accu + elt);
        return knownAbbreviations.indexOf(tmp) > -1;
    }, peg$c15 = function (word) {
        return text();
    }, peg$c16 = /^[^ \t\n\r!?.([})\]}`"0-9@]/, peg$c17 = peg$classExpectation([" ", "\t", "\n", "\r", "!", "?", ".", "(", "[", "}", ")", "]", "}", "`", "\"", ["0", "9"], "@"], true, false), peg$c18 = function () {
        return text();
    }, peg$c19 = /^[0-9]/, peg$c20 = peg$classExpectation([["0", "9"]], false, false), peg$c21 = peg$anyExpectation(), peg$c22 = /^[a-z]/, peg$c23 = peg$classExpectation([["a", "z"]], false, false), peg$c24 = /^[@]/, peg$c25 = peg$classExpectation(["@"], false, false), peg$c26 = /^[.]/, peg$c27 = peg$classExpectation(["."], false, false), peg$c28 = "http://", peg$c29 = peg$literalExpectation("http://", false), peg$c30 = "https://", peg$c31 = peg$literalExpectation("https://", false), peg$c32 = /^[a-z0-9]/, peg$c33 = peg$classExpectation([["a", "z"], ["0", "9"]], false, false), peg$c34 = /^[\/]/, peg$c35 = peg$classExpectation(["/"], false, false), peg$c36 = function () {
        return text();
    }, peg$c37 = /^[([{"'`\u2018]/, peg$c38 = peg$classExpectation(["(", "[", "{", "\"", "'", "`", "\u2018"], false, false), peg$c39 = /^[)\]}"'`\u2019]/, peg$c40 = peg$classExpectation([")", "]", "}", "\"", "'", "`", "\u2019"], false, false), peg$currPos = 0, peg$savedPos = 0, peg$posDetailsCache = [{ line: 1, column: 1 }], peg$maxFailPos = 0, peg$maxFailExpected = [], peg$silentFails = 0, peg$result;
    ...
    const knownAbbreviations = { knownAbbreviations }.knownAbbreviations;
